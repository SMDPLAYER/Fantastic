package uz.smd.fantastic.data.local

import android.content.Context
import com.mysoftpanda.android.onlineexam.data.local.BooleanPreferenceDefTrue
import com.mysoftpanda.android.onlineexam.data.local.StringPreference
